...
/** Object providing factory methods to create attribute DSL instances
  * for use in the OLAP DSL.
  */
object AttributeDSL:
  trait AttributeDSL extends Attribute

  /** A concrete implementation of `Attribute` used to define attributes with
    * a value.
    *
    * @param name
  ...
  /** A concrete implementation of `Attribute` used to define attributes
    * without a value.
    *
